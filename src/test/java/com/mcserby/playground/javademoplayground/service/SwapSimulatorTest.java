...
class SwapSimulatorTest {
    ...
    void testSwap() throws InterruptedException {
        ...
        generatePersons(100);
        Agency agency1 = RandomEntityGenerator.generateRandomAgency(1, 20, 1_000_000.0, random);
        agencyRepository.save(agency1);

        Agency agency2 = RandomEntityGenerator.generateRandomAgency(1, 20, 1_000_000.0, random);
    ...
    private void generatePersons(int number) {
        ...
        IntStream.range(0, number).forEach(i -> {
            createPerson(RandomEntityGenerator.generateRandomString(20, random));
        });
    }
